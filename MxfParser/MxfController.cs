...
/// <summary>
    ...
    public sealed class MxfController : ImportFileBase
    {
        ...
        public override string Process(string fileName, ImportFileSpec fileSpec)
        {
            ...
            if (mxfChannels != null)
                MergeChannels(mxfChannels, fileSpec.Precedence);
        ...
        private void processProgramme(TVStation station, MxfScheduleEntry scheduleEntry, bool noLookup)
        {
            ...
            if (programme.KeyWords != null)
            {
                ...
                if (keywords.Length != 0)
                {
                    ...
                    if (keywordString.Length != 0)
                        epgEntry.EventCategory = new EventCategorySpec(keywordString.ToString());
                }
            }
            ...
            if (programme.GuideImage != null)
                epgEntry.Poster = programme.GuideImage.Substring(2);

            if (programme.Actors != null && programme.Actors.Count != 0)
            {
                foreach (MxfProgrammePerson actor in programme.Actors)
                {
                    MxfPerson person = MxfPerson.FindPerson(actor.Person);
                    if (person != null)
                    {
                        if (epgEntry.Cast == null)
                            epgEntry.Cast = new Collection<Person>();
                        epgEntry.Cast.Add(new Person(person.Name, "Actor", actor.Character, actor.RankNumber));
                    }
                }
            }
            ...
            {
                foreach (MxfProgrammePerson director in programme.Directors)
                {
                    MxfPerson person = MxfPerson.FindPerson(director.Person);
                    if (person != null)
                    {
                        if (epgEntry.Directors == null)
                            epgEntry.Directors = new Collection<Person>();
                        epgEntry.Directors.Add(new Person(person.Name, "Director", null, director.RankNumber));
                    }
                }
            }
            ...
            { 
                foreach (MxfProgrammePerson producer in programme.Producers)
                {
                    MxfPerson person = MxfPerson.FindPerson(producer.Person);
                    if (person != null)
                    {
                        if (epgEntry.Producers == null)
                            epgEntry.Producers = new Collection<Person>();
                        epgEntry.Producers.Add(new Person(person.Name, "Producer", null, producer.RankNumber));
                    }
                }
            }
            ...
            {
                foreach (MxfProgrammePerson writer in programme.Writers)
                {
                    MxfPerson person = MxfPerson.FindPerson(writer.Person);
                    if (person != null)
                    {
                        if (epgEntry.Writers == null)
                            epgEntry.Writers = new Collection<Person>();
                        epgEntry.Writers.Add(new Person(person.Name, "Writer", null, writer.RankNumber));
                    }
                }
            }
            ...
            {
                foreach (MxfProgrammePerson host in programme.Hosts)
                {
                    MxfPerson person = MxfPerson.FindPerson(host.Person);
                    if (person != null)
                    {
                        if (epgEntry.Presenters == null)
                            epgEntry.Presenters = new Collection<Person>();
                        epgEntry.Presenters.Add(new Person(person.Name, "Presenter", null, host.RankNumber));
                    }
                }
            }
            ...
            {
                foreach (MxfProgrammePerson guestStar in programme.GuestStars)
                {
                    MxfPerson person = MxfPerson.FindPerson(guestStar.Person);
                    if (person != null)
                    {
                        if (epgEntry.GuestStars == null)
                            epgEntry.GuestStars = new Collection<Person>();
                        epgEntry.GuestStars.Add(new Person(person.Name, "Guest Star", null, guestStar.RankNumber));
                    }
                }
            }
