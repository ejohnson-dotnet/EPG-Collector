...
namespace MxfParser
{
    ...
    public class MxfProgramme
    {
        ...
        /// </summary>
        public Collection<MxfProgrammePerson> Actors { get; private set; }

        /// <summary>
        /// Get the director list for the programme.
        /// </summary>
        public Collection<MxfProgrammePerson> Directors { get; private set; }

        /// <summary>
        /// Get the producer list for the programme.
        /// </summary>
        public Collection<MxfProgrammePerson> Producers { get; private set; }

        /// <summary>
        /// Get the writer list for the programme.
        /// </summary>
        public Collection<MxfProgrammePerson> Writers { get; private set; }

        /// <summary>
        /// Get the host list for the programme.
        /// </summary>
        public Collection<MxfProgrammePerson> Hosts { get; private set; }

        /// <summary>
        /// Get the guest star list for the programme.
        /// </summary>
        public Collection<MxfProgrammePerson> GuestStars { get; private set; }

        private Collection<string> progIds = new Collection<string>();
        ...
        private bool load(XmlReader xmlReader, XmlReader personReader)
        {
            try
            {
                ...
                if (progIds.Contains(Uid))
                    Logger.Instance.Write("Duplicate programme UID: " + Title);
                else
                    progIds.Add(Uid);
                ...
                while (!personReader.EOF)
                {
                    if (personReader.IsStartElement())
                    {
                        switch (personReader.Name.ToLowerInvariant())
                        {
                            case "actorrole":
                                if (Actors == null)
                                    Actors = new Collection<MxfProgrammePerson>();
                                Actors.Add(new MxfProgrammePerson(personReader.GetAttribute("person"), personReader.GetAttribute("rank"), personReader.GetAttribute("character")));
                                break;
                            case "directorrole":
                                if (Directors == null)
                                    Directors = new Collection<MxfProgrammePerson>();
                                Directors.Add(new MxfProgrammePerson(personReader.GetAttribute("person"), personReader.GetAttribute("rank"), null));
                                break;
                            case "producerrole":
                                if (Producers == null)
                                    Producers = new Collection<MxfProgrammePerson>();
                                Producers.Add(new MxfProgrammePerson(personReader.GetAttribute("person"), personReader.GetAttribute("rank"), null));
                                break;
                            case "writerrole":
                                if (Writers == null)
                                    Writers = new Collection<MxfProgrammePerson>();
                                Writers.Add(new MxfProgrammePerson(personReader.GetAttribute("person"), personReader.GetAttribute("rank"), null));
                                break;
                            case "hostrole":
                                if (Hosts == null)
                                    Hosts = new Collection<MxfProgrammePerson>();
                                Hosts.Add(new MxfProgrammePerson(personReader.GetAttribute("person"), personReader.GetAttribute("rank"), null));
                                break;
                            case "guestrole":
                                if (GuestStars == null)
                                    GuestStars = new Collection<MxfProgrammePerson>();
                                GuestStars.Add(new MxfProgrammePerson(personReader.GetAttribute("person"), personReader.GetAttribute("rank"), null));
                                break;
                            default:
                                break;
                        }
