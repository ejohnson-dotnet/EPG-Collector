...
namespace DVBServices
{
    ...
    public class EITEntry
    {
            ...
            get
            {
                if (!string.IsNullOrWhiteSpace(ShortDescription))
                {
                    ...
                    else
                    {
                        ...
                        if (!string.IsNullOrWhiteSpace(ExtendedDescription))
                        {
                            string extendedDescription = ExtendedDescription.Trim();
                            
                            if (extendedDescription.StartsWith(trimDescription))
                                return extendedDescription;

                            if (RunParameters.Instance.CurrentFrequency.AdvancedRunParamters.CountryCode == "NDL")
                            {
                                if (trimDescription.Length > extendedDescription.Length)
        ...
        /// Get the producers.
        /// </summary>
        public Collection<string> Producers { get { return (producers); } }
        ...
        /// </summary>
        public int EpisodeCount { get { return (episodeCount); } }
        ...
        private void processExtendedEventDescriptor(DVBExtendedEventDescriptor extendedEventDescriptor)
        {
            ...
            if (extendedEventDescriptor.Producers != null)
                producers = extendedEventDescriptor.Producers;
            ...
            if (extendedEventDescriptor.EpisodeCount != -1 && episodeCount == -1)
                episodeCount = extendedEventDescriptor.EpisodeCount;
        }
