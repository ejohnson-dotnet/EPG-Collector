...
namespace DVBServices
{
    ...
    public class AtscPsipController : ControllerBase
    {
        ...
        private EventCategorySpec getEventCategory(string title, string description, EventInformationTableEntry eventEntry)
        {
            ...
            ProgramCategory category = AtscPsipProgramCategory.GetCategory(eventEntry);
            if (category != null)
        ...
        public override void FinishFrequency()
        {
            ...
            AtscPsipProgramCategory.LogUsage(AtscPsipProgramCategory.Categories, AtscPsipProgramCategory.UndefinedCategories, "ATSC PSIP");
