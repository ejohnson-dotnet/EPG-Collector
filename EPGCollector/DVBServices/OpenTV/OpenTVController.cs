...
namespace DVBServices
{
    ...
    public class OpenTVController : ControllerBase
    {
        ...
        public override CollectorReply Process(ISampleDataProvider dataProvider, BackgroundWorker worker, CollectionSpan collectionSpan)
        {
            ...
            {
                OpenTVProgramCategory.Load(OpenTVProgramCategory.FileName, RunParameters.Instance.CurrentFrequency.AdvancedRunParamters.CountryCode.Trim());
        ...
        public override void FinishFrequency()
        {
            ...
            OpenTVProgramCategory.LogUsage(OpenTVProgramCategory.Categories, OpenTVProgramCategory.UndefinedCategories, "OpenTV");            
