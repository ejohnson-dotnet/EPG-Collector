...
namespace DomainObjects
{
    ...
    public class WMCChannel
    {
        ...
        /// </summary>
        /// <param name="reader"></param>
        public void LoadDigitalCableTuningInfo(XmlReader reader)
        {
            WMCDigitalCableTuningInfo tuningInfo = new WMCDigitalCableTuningInfo(
                Int32.Parse(reader.GetAttribute("channelNumber")));
