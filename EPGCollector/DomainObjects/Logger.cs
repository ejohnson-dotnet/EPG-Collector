...
namespace DomainObjects
{
    ...
    public class Logger : ILogger
    {
        ...
        /// </summary>
        public static string StreamFilePath { get { return (Path.Combine(RunParameters.DataDirectory, streamFileName)); } }        
        ...
        private static string streamFileName = "EPG Collector Stream.log";
