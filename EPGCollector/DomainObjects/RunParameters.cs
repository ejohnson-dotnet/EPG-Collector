...
namespace DomainObjects
{
    ...
    public class RunParameters
    {
        ...
        /// </summary>
        public static bool IsWinXp { get { return Environment.OSVersion.Version.Major == 5; } }
        /// <summary>
        /// Return true if Win7 or later; otherwise false. 
        /// </summary>
        public static bool IsWin7OrLater { get { return Environment.OSVersion.Version.Major > 5; } }
        ...
        /// </summary>
        public int LookupMatchThreshold
        {
            get { return (lookupMatchThreshold); }
            set { lookupMatchThreshold = value; }
        }
        ...
        /// </summary>
        public bool LookupOverwrite
        {
            get { return (lookupOverwrite); }
            set { lookupOverwrite = value; }
        }

        /// <summary>
        /// Get or set the episode search priority for lookups.
        /// </summary>
        public EpisodeSearchPriority LookupEpisodeSearchPriority
        {
            get { return (lookupEpisodeSearchPriority); }
            set { lookupEpisodeSearchPriority = value; }
        }

        /// <summary>
        /// Get or set the TVDB pin number.
        /// </summary>
        public string LookupTVDBPin
        {
            get { return (lookupTVDBPin); }
            set { lookupTVDBPin = value; }
        }
        ...
        /// <summary>
        /// Get or set the Satellite Definition files directory name.
        /// </summary>
        public string SatelliteDefFilesDirectory
        {
            get { return (satelliteDefFilesDirectory); }
            set { satelliteDefFilesDirectory = value; }
        }

        /// <summary>
        /// Get or set the Channel Definition file name.
        /// </summary>
        public string ChannelDefinitionFileName
        {
            get { return (channelDefinitionFileName); }
            set { channelDefinitionFileName = value; }
        }
        ...
        public bool ChannelDataNeeded
        {
            get
            {
                if (CurrentFrequency.AdvancedRunParamters.ChannelBouquet != -1 ||
                    ...
                    OptionEntry.IsDefined(this.Options, OptionName.CreateArChannels) ||
                    OptionEntry.IsDefined(this.Options, OptionName.CreateChannelDefFile) ||
        ...
        public bool NetworkDataNeeded
        {
            get
            {
                if (OptionEntry.IsDefined(OptionName.CreateChannelDefFile) ||
                    OptionEntry.IsDefined(OptionName.CreateSatIni) ||
        ...
        {
            get { return (channelLogoPath); }
            set { channelLogoPath = value; }
        }
        ...
        /// </summary>
        public bool ScannedChannels { get; private set; }

        /// <summary>
        /// Get the text for no programme description available. 
        /// </summary>
        public static string NoProgrammeDescription { get { return "No Synopsis Available"; } }
        ...
        { 
            get { return translationApiKey; }
            set { translationApiKey = value; }
        }
        /// <summary>
        ...
        { 
            get { return translationLanguage; }
            set { translationLanguage = value; }
        }
        /// <summary>
        /// Get or set the list of channels and options for text translations.
        /// </summary>
        public Collection<TextTranslationSpec> TranslationSpecs 
        { 
            get { return translationSpecs; }
            set { translationSpecs = value; }
        }

        /// <summary>
        /// Get or set the path prefix for XMLTV icon tags.
        /// </summary>
        public string XmltvIconTagPathPrefix
        {
            get { return (xmltvIconTagPathPrefix); }
            set { xmltvIconTagPathPrefix = value; }
        }

        /// <summary>
        /// Get or set the Schedules Direct channels.
        /// </summary>
        public Collection<SchedulesDirectChannel> SdChannels
        {
            get { return (sdChannels); }
            set { sdChannels = value; }
        }

        /// <summary>
        /// Get or set the flag that controls the local storage of Schedules Direct images.
        /// </summary>
        public ImportImageMode SdStoreImagesLocally
        {
            get { return (sdStoreImagesLocally); }
            set { sdStoreImagesLocally = value; }
        }

        /// <summary>
        /// Get or set the flag that controls the description length Schedules Direct program descriptions.
        /// </summary>
        public bool SdUseLongDescriptions
        {
            get { return (sdUseLongDescriptions); }
            set { sdUseLongDescriptions = value; }
        }
        ...
        private Collection<TextTranslationSpec> translationSpecs;
        ...
        private string satelliteDefFilesDirectory;
        private string channelDefinitionFileName;
        ...
        private int lookupMatchThreshold = 0;
        ...
        private Collection<SchedulesDirectChannel> sdChannels;
        private ImportImageMode sdStoreImagesLocally;
        private bool sdUseLongDescriptions;
                ...
                if (parts.Length > 0)
                {
                    switch (parts[0].Trim().ToUpperInvariant())
                    {
                        ...
                        case "LOOKUPMATCHING":
                            ...
                            break;
                        case "LOOKUPMATCHTHRESHOLD":
                            Logger.Instance.Write("Processing ini parameter: " + line);
                            reply = processLookupMatchThreshold(parts[1]);
                            break;
                        case "LOOKUPNOTFOUND":
                            Logger.Instance.Write("Processing ini parameter: " + line);
                        ...
                        case "XMLTVICONTAGPATHPREFIX":
                            Logger.Instance.Write("Processing ini parameter: " + line);
                            reply = processXmltvIconTagPathPrefix(parts[1]);
                            break;
                        ...
                        case "LOOKUPIMAGESINBASE":
                            ...
                            break;
                        case "LOOKUPOVERWRITE":
                            Logger.Instance.Write("Processing ini parameter: " + line);
                            reply = processLookupOverwrite(parts[1]);
                            break;
                        case "LOOKUPEPISODESEARCHPRIORITY":
                            Logger.Instance.Write("Processing ini parameter: " + line);
                            reply = processLookupEpisodeSearchPriority(parts[1]);
                            break;
                        case "LOOKUPTVDBPIN":
                            Logger.Instance.Write("Processing ini parameter: " + line);
                        ...
                        case "SAGETVSATNUM":
                            ...
                            break;
                        case "SATELLITEDEFFILESDIRECTORY":
                            Logger.Instance.Write("Processing ini parameter: " + line);
                            reply = processSatelliteDefFilesDirectory(parts[1]);
                            break;
                        case "CHANNELDEFINITIONFILENAME":
                            Logger.Instance.Write("Processing ini parameter: " + line);
                            reply = processChannelDefinitionFileName(parts[1]);
                            break;
                        case "SATIPTUNER":
                            Logger.Instance.Write("Processing ini parameter: " + line);
                        ...
                        case "EITCAROUSEL":
                            ...
                            break;
                        case "CHANNELLOGOPATH":
                            Logger.Instance.Write("Processing ini parameter: " + line);
                            reply = processChannelLogoPath(parts[1]);
                            break;
                        case "TRANSLATIONAPIKEY":
                            Logger.Instance.Write("Processing ini parameter: " + line);
                            reply = processTranslationApiKey(parts[1]);
                            break;
                        case "TRANSLATIONLANGUAGE":
                            Logger.Instance.Write("Processing ini parameter: " + line);
                            reply = processTranslationLanguage(parts[1]);
                            break;
                        case "TRANSLATIONSPEC":
                            Logger.Instance.Write("Processing ini parameter: " + line);
                            reply = processTranslationSpec(parts[1]);
                            break;
                        case "SDSTOREIMAGESLOCALLY":
                            Logger.Instance.Write("Processing ini parameter: " + line);
                            reply = processSdStoreImagesLocally(parts[1]);
                            break;
                        case "SDUSELONGDESCRIPTIONS":
                            Logger.Instance.Write("Processing ini parameter: " + line);
                            reply = processSdUseLongDescriptions(parts[1]);
                            break;
                        case "SDCHANNEL":
                            Logger.Instance.Write("Processing ini parameter: " + line);
                            reply = processSdChannel(parts[1]);
                            break;
                        case "SDCHANNELLOGO":
                            Logger.Instance.Write("Processing ini parameter: " + line);
                            reply = processSdChannelLogo(parts[1]);
                            break;
                        case "[GENERAL]":
                        case "[DIAGNOSTICS]":
                        case "[SCANLIST]":
        ...
        private ExitCode processTuningFile(string parts)
        {
            ...
            if (satelliteFrequency != null)
            {
                if (runType != RunType.Centre)
                {
                    satelliteFrequency.Provider = new Satellite(fileName);
                    return (ExitCode.OK);
                }
                else
                {
                    satelliteFrequency.Provider = Satellite.FindSatellite(fileName);
                    if (satelliteFrequency.Provider != null)
                        return (ExitCode.OK);
                    else
                    {
            ...
            if (terrestrialFrequency != null)
            {
                if (runType != RunType.Centre)
                {
                    terrestrialFrequency.Provider = new TerrestrialProvider(fileName);
                    return (ExitCode.OK);
                }
                else
                {
                    terrestrialFrequency.Provider = TerrestrialProvider.FindProvider(fileName);
                    if (terrestrialFrequency.Provider != null)
                        return (ExitCode.OK);
                    else
                    {
                        lastError = "INI file format error: A TuningFile parameter references an unknown tuning file - " + fileName + ".";
            ...
            if (cableFrequency != null)
            {
                if (runType != RunType.Centre)
                {
                    cableFrequency.Provider = new CableProvider(fileName);
                    return (ExitCode.OK);
                }
                else
                {
                    cableFrequency.Provider = CableProvider.FindProvider(fileName);
                    if (cableFrequency.Provider != null)
                        return (ExitCode.OK);
                    else
                    {
                        lastError = "INI file format error: A TuningFile parameter references an unknown tuning file - " + fileName + ".";
            ...
            if (atscFrequency != null)
            {
                if (runType != RunType.Centre)
                {
                    atscFrequency.Provider = new AtscProvider(fileName);
                    return (ExitCode.OK);
                }
                else
                {
                    atscFrequency.Provider = AtscProvider.FindProvider(fileName);
                    if (atscFrequency.Provider != null)
                        return (ExitCode.OK);
                    else
                    {
                        lastError = "INI file format error: A TuningFile parameter references an unknown tuning file - " + fileName + ".";
            ...
            if (clearQamFrequency != null)
            {
                if (runType != RunType.Centre)
                {
                    clearQamFrequency.Provider = new ClearQamProvider(fileName);
                    return (ExitCode.OK);
                }
                else
                {
                    clearQamFrequency.Provider = ClearQamProvider.FindProvider(fileName);
                    if (clearQamFrequency.Provider != null)
                        return (ExitCode.OK);
                    else
                    {
                        lastError = "INI file format error: A TuningFile parameter references an unknown tuning file - " + fileName + ".";
            ...
            if (isdbSatelliteFrequency != null)
            {
                if (runType != RunType.Centre)
                {
                    isdbSatelliteFrequency.Provider = new ISDBSatelliteProvider(fileName);
                    return (ExitCode.OK);
                }
                else
                {
                    isdbSatelliteFrequency.Provider = ISDBSatelliteProvider.FindProvider(fileName);
                    if (isdbSatelliteFrequency.Provider != null)
                        return (ExitCode.OK);
                    else
                    {
                        lastError = "INI file format error: A TuningFile parameter references an unknown tuning file - " + fileName + ".";
            ...
            if (isdbTerrestrialFrequency != null)
            {
                if (runType != RunType.Centre)
                {
                    isdbTerrestrialFrequency.Provider = new ISDBTerrestrialProvider(fileName);
                    return (ExitCode.OK);
                }
                else
                {
                    isdbTerrestrialFrequency.Provider = ISDBTerrestrialProvider.FindProvider(fileName);
                    if (isdbTerrestrialFrequency.Provider != null)
                        return (ExitCode.OK);
                    else
                    {
                        lastError = "INI file format error: A TuningFile parameter references an unknown tuning file - " + fileName + ".";
        ...
        private ExitCode processLookupMatchThreshold(string parts)
        {
            if (string.IsNullOrWhiteSpace(parts.Trim()))
            {
                lastError = "INI file format error: The LookupMatchThreshold line parameter is missing.";
                Logger.Instance.Write(lastError);
                return (ExitCode.ParameterError);
            }
            ...
            try
            {
                lookupMatchThreshold = Int32.Parse(parts.Trim());
            }
            catch (FormatException)
            {
                lastError = "INI file format error: The LookupMatchThreshold parameter is in the wrong format.";
                Logger.Instance.Write(lastError);
                return (ExitCode.ParameterError);
            }
            catch (OverflowException)
            {
                lastError = "INI file format error: The LookupMatchThreshold parameter is out of range.";
                Logger.Instance.Write(lastError);
                return (ExitCode.ParameterError);
            }
        ...
        private ExitCode processXmltvIconTagPathPrefix(string parts)
        {
            if (string.IsNullOrWhiteSpace(parts.Trim()))
            {
                lastError = "INI file format error: The LookupXmltvImageTagPath/XmltvIconTagPathPrefix line parameter is missing.";
                Logger.Instance.Write(lastError);
                return (ExitCode.ParameterError);
            }

            xmltvIconTagPathPrefix = parts.Trim();
        ...
        private ExitCode processLookupOverwrite(string parts)
        {
            if (string.IsNullOrWhiteSpace(parts.Trim()))
            {
                lastError = "INI file format error: The LookupOverwrite line parameter is missing.";
                Logger.Instance.Write(lastError);
                return (ExitCode.ParameterError);
            }

            if (parts.Trim().ToLowerInvariant() == "yes")
                LookupOverwrite = true;
            else
            {
                if (parts.Trim().ToLowerInvariant() == "no")
                    LookupOverwrite = false;
                else
                {
                    lastError = "INI file format error: The LookupOverwrite line parameter is incorrect.";
                    Logger.Instance.Write(lastError);
                    return (ExitCode.ParameterError);
                }
            }
        ...
        private ExitCode processLookupEpisodeSearchPriority(string parts)
        {
            if (string.IsNullOrWhiteSpace(parts.Trim()))
            {
                lastError = "INI file format error: The LookupEpisodeSearchPriority line parameter is missing.";
                Logger.Instance.Write(lastError);
                return (ExitCode.ParameterError);
            }
            ...
            try
            {
                LookupEpisodeSearchPriority = (EpisodeSearchPriority)Enum.Parse(typeof(EpisodeSearchPriority), parts);
            }
            catch (ArgumentException)
            {
                lastError = "INI file format error: The LookupEpisodeSearchPriority line parameter is incorrect.";
                Logger.Instance.Write(lastError);
                return (ExitCode.ParameterError);
            }
            catch (OverflowException)
        ...
        private ExitCode processLookupTVDBPin(string parts)
        {
            if (string.IsNullOrWhiteSpace(parts.Trim()))
            {
                lastError = "INI file format error: The LookupTVDBPin line parameter is missing.";
                Logger.Instance.Write(lastError);
                return (ExitCode.ParameterError);
            }

            lookupTVDBPin = parts.Trim();
        ...
        {
            string[] parameters = parts.Split(new char[] { ',' });
            if (parameters.Length < 2 || parameters.Length > 12)
            {
                lastError = "INI file format error: An XmltvFile line has the wrong number of parameters (2-12).";
                Logger.Instance.Write(lastError);
                return (ExitCode.ParameterError);
            }
            ...
            if (parameters.Length > 5)
            {
                try
                {
                    ...
                    if (importFileSpec.AppendOnly)
                        importFileSpec.Precedence = DataPrecedence.ImportAppend;
                }
                catch (ArgumentException)
                {
                    lastError = "INI file format error: An XmltvFile line append parameter is incorrect.";
                    Logger.Instance.Write(lastError);
                    return (ExitCode.ParameterError);
                }
            }
            ...
            if (parameters.Length > 6)
            {
                if (parameters[6].Trim().ToLowerInvariant() != "local")
                    importFileSpec.TimeZone = parameters[6].Trim();
            }
            ...
            if (parameters.Length > 7)
            {
                try
                {
                    importFileSpec.IgnoreEpisodeTags = bool.Parse(parameters[7].Trim());
                }
                catch (ArgumentException)
                {
                    lastError = "INI file format error: An XmltvFile line time zone parameter is incorrect.";
                    Logger.Instance.Write(lastError);
                    return (ExitCode.ParameterError);
                }
            }
            ...
            if (parameters.Length > 8)
            {
                switch (parameters[8].Trim().ToLowerInvariant())
                {
                    case "none":
                    case "false":
                        importFileSpec.StoreImagesLocally = ImportImageMode.None;
                        break;
                    case "channels":
                        importFileSpec.StoreImagesLocally = ImportImageMode.Channels;
                        break;
                    case "programmes":
                        importFileSpec.StoreImagesLocally = ImportImageMode.Programmes;
                        break;
                    case "true":
                    case "both":
                        importFileSpec.StoreImagesLocally = ImportImageMode.Both;
                        break;
                    default:
                        lastError = "INI file format error: An XmltvFile line store images locvally parameter is incorrect.";
                        Logger.Instance.Write(lastError);
                        return (ExitCode.ParameterError);
                }
            }
            ...
            if (parameters.Length > 9)
            {
                try
                {
                    importFileSpec.ProcessNewTag = bool.Parse(parameters[9].Trim());
                }
                catch (ArgumentException)
                {
                    lastError = "INI file format error: An XmltvFile line process new tag parameter is incorrect.";
                    Logger.Instance.Write(lastError);
                    return (ExitCode.ParameterError);
                }
            }
            ...
            if (parameters.Length > 10)
            {
                try
                {
                    importFileSpec.SetPreviouslyShownDefault = bool.Parse(parameters[10].Trim());
                }
                catch (ArgumentException)
                {
                    lastError = "INI file format error: An XmltvFile line process new tag parameter is incorrect.";
            ...
            if (parameters.Length > 11)
            {
                try
                {
                    importFileSpec.ProcessLiveTag = bool.Parse(parameters[11].Trim());
                }
                catch (ArgumentException)
                {
                    lastError = "INI file format error: An XmltvFile line process live tag parameter is incorrect.";
                    Logger.Instance.Write(lastError);
                    return (ExitCode.ParameterError);
                }
            }
        ...
        private ExitCode processXmltvChannelChange(string parts)
        {
            ...
            try
            {
                ...
                if (parameters.Length > 4)
                    xmltvChannelChange.CallSign = parameters[4].Trim();
            }
            catch (ArgumentException)
            {
        ...
        private ExitCode processSatelliteDefFilesDirectory(string parts)
        {
            if (string.IsNullOrWhiteSpace(parts.Trim()))
            {
                lastError = "INI file format error: The SatelliteDefFilesDirectory line parameter is missing.";
                Logger.Instance.Write(lastError);
                return (ExitCode.ParameterError);
            }

            satelliteDefFilesDirectory = parts.Trim();
            return (ExitCode.OK);
        }

        private ExitCode processChannelDefinitionFileName(string parts)
        {
            if (string.IsNullOrWhiteSpace(parts.Trim()))
            {
                lastError = "INI file format error: The ChannelDefinitionFileName line parameter is missing.";
                Logger.Instance.Write(lastError);
                return (ExitCode.ParameterError);
            }

            channelDefinitionFileName = parts.Trim();
            return (ExitCode.OK);
        }
        ...
        private ExitCode processChannelLogoPath(string parts)
        {
            if (string.IsNullOrWhiteSpace(parts.Trim()))
            {
                lastError = "INI file format error: The ChannelLogoPath line parameter is missing.";
                Logger.Instance.Write(lastError);
                return (ExitCode.ParameterError);
            }

            channelLogoPath = parts.Trim();
            return (ExitCode.OK);
        }

        private ExitCode processTranslationApiKey(string parts)
        {
            if (string.IsNullOrWhiteSpace(parts.Trim()))
            {
                lastError = "INI file format error: The TranslationsApiKey line parameter is missing.";
                Logger.Instance.Write(lastError);
                return (ExitCode.ParameterError);
            }

            translationApiKey = parts.Trim();
            return (ExitCode.OK);
        }

        private ExitCode processTranslationLanguage(string parts)
        {
            if (string.IsNullOrWhiteSpace(parts.Trim()))
            {
                lastError = "INI file format error: The TranslationsLangauge line parameter is missing.";
                Logger.Instance.Write(lastError);
                return (ExitCode.ParameterError);
            }

            translationLanguage = parts.Trim();
            return (ExitCode.OK);
        }

        private ExitCode processTranslationSpec(string parts)
        {
            string[] parameters = parts.Split(new char[] { ',' });
            if (parameters.Length != 3)
            {
                lastError = "INI file format error: A TranslationSpec line has the wrong number of parameters (3-5).";
                Logger.Instance.Write(lastError);
                return (ExitCode.ParameterError);
            }

            TextTranslationSpec translationSpec = new TextTranslationSpec(); 

            try
            {
                translationSpec.OriginalNetworkID = Int32.Parse(parameters[0].Trim());
                translationSpec.TransportStreamID = Int32.Parse(parameters[1].Trim());
                translationSpec.ServiceID = Int32.Parse(parameters[2].Trim());
            }
            catch (FormatException)
            {
                lastError = "INI file format error: A TranslationSpec line parameter is in the wrong format.";
                Logger.Instance.Write(lastError);
                return (ExitCode.ParameterError);
            }
            catch (OverflowException)
            {
                lastError = "INI file format error: A TranslationSpec line parameter is out of range.";
                Logger.Instance.Write(lastError);
                return (ExitCode.ParameterError);
            }

            if (translationSpecs == null)
                translationSpecs = new Collection<TextTranslationSpec>();
            translationSpecs.Add(translationSpec);

            return (ExitCode.OK);
        }

        private ExitCode processSdStoreImagesLocally(string parts)
        {
            if (string.IsNullOrWhiteSpace(parts.Trim()))
            {
                lastError = "INI file format error: The SDStoreImagesLocally line parameter is missing.";
                Logger.Instance.Write(lastError);
                return (ExitCode.ParameterError);
            }

            switch (parts.Trim().ToLowerInvariant())
            {
                case "none":
                    sdStoreImagesLocally = ImportImageMode.None;
                    break;
                case "channels":
                    sdStoreImagesLocally = ImportImageMode.Channels;
                    break;
                case "programmes":
                    sdStoreImagesLocally = ImportImageMode.Programmes;
                    break;
                case "both":
                    sdStoreImagesLocally = ImportImageMode.Both;
                    break;
                default:
                    lastError = "INI file format error: The SDStoreImagesLocally line parameter is incorrect.";
                    Logger.Instance.Write(lastError);
                    return (ExitCode.ParameterError);
            }
        ...
        private ExitCode processSdUseLongDescriptions(string parts)
        {
            if (string.IsNullOrWhiteSpace(parts.Trim()))
            {
                lastError = "INI file format error: The SDUseLongDescriptions line parameter is missing.";
                Logger.Instance.Write(lastError);
                return (ExitCode.ParameterError);
            }

            if (parts.Trim().ToLowerInvariant() == "yes")
                sdUseLongDescriptions = true;
            else
            {
                if (parts.Trim().ToLowerInvariant() == "no")
                    sdUseLongDescriptions = false;
                else
                {
                    lastError = "INI file format error: The SDUseLongDescriptions line parameter is incorrect.";
                    Logger.Instance.Write(lastError);
                    return (ExitCode.ParameterError);
                }
            }
        ...
        private ExitCode processSdChannel(string parts)
        {
            string[] parameters = parts.Split(new char[] { ',' });
            if (parameters.Length != 13)
            {
                lastError = "INI file format error: An SDChannel line has the wrong number of parameters (13).";
                Logger.Instance.Write(lastError);
                return (ExitCode.ParameterError);
            }
            ...
            try
            {
                channel.Identity = parameters[0].Trim();
                channel.Name = parameters[1].Trim();
                channel.CallSign = parameters[2].Trim();
                channel.Affiliate = parameters[3].Trim();
                channel.LineupIdentity = parameters[4].Trim();
                channel.UserName = parameters[5].Trim();
                channel.UserCallSign = parameters[6].Trim();
                channel.MajorChannelNumber = Int32.Parse(parameters[7].Trim());
                channel.MinorChannelNumber = Int32.Parse(parameters[8].Trim());
                channel.OriginalNetworkId = Int32.Parse(parameters[9].Trim());
                channel.TransportStreamId = Int32.Parse(parameters[10].Trim());
                channel.ServiceId = Int32.Parse(parameters[11].Trim());
                channel.Excluded = bool.Parse(parameters[12].Trim());

                if (string.IsNullOrWhiteSpace(channel.Identity) ||
                    string.IsNullOrWhiteSpace(channel.Name) ||
                    string.IsNullOrWhiteSpace(channel.CallSign) ||
                    string.IsNullOrWhiteSpace(channel.LineupIdentity))
                {
                    lastError = "INI file format error: A SDLineup line parameter is in the wrong format.";
                    Logger.Instance.Write(lastError);
                    return (ExitCode.ParameterError);
                }
            }
            ...
            if (sdChannels == null)
                sdChannels = new Collection<SchedulesDirectChannel>();
            sdChannels.Add(channel);

            return (ExitCode.OK);
        }

        private ExitCode processSdChannelLogo(string parts)
        {
            if (string.IsNullOrWhiteSpace(parts.Trim()))
            {
                lastError = "INI file format error: The SDChannelLogo line parameter is missing.";
                Logger.Instance.Write(lastError);
                return (ExitCode.ParameterError);
            }

            if (sdChannels == null || sdChannels.Count == 0)
            {
                lastError = "INI file format error: The SDChannelLogo line parameter is in the wrong place.";
                Logger.Instance.Write(lastError);
                return (ExitCode.ParameterError);
            }

            SchedulesDirectChannel channel = sdChannels[sdChannels.Count - 1];

            if (channel.Logos == null)
                channel.Logos = new Collection<string>();
            channel.Logos.Add(parts.Trim());                
        ...
        public string Save(string fileName)
        {
            ...
            try
            {
                ...
                outputTranslateParameters(streamWriter);
                outputScheduleDirectParameters(streamWriter);
        ...
        private void outputGeneralParameters(StreamWriter streamWriter)
        {
            ...
            if (satelliteDefFilesDirectory != null)
                streamWriter.WriteLine("SatelliteDefFilesDirectory=" + satelliteDefFilesDirectory);
            if (channelDefinitionFileName != null)
                streamWriter.WriteLine("ChannelDefinitionFileName=" + channelDefinitionFileName);
            if (!string.IsNullOrWhiteSpace(channelLogoPath))
                streamWriter.WriteLine("ChannelLogoPath=" + channelLogoPath);
            if (xmltvIconTagPathPrefix != null)
                streamWriter.WriteLine("XmltvIconTagPathPrefix=" + xmltvIconTagPathPrefix);
        ...
        private void outputLookupParameters(StreamWriter streamWriter)
        {
            ...
            if (LookupOverwrite)
                streamWriter.WriteLine("LookupOverwrite=yes");
            else
        ...
        private void outputXmltvFileParameters(StreamWriter streamWriter)
        {
            ...
            foreach (ImportFileSpec xmltvFileSpec in importFiles)
            {
                streamWriter.WriteLine("XmltvImportFile=" + xmltvFileSpec.FileName + "," +
                    ...
                    xmltvFileSpec.IgnoreEpisodeTags + "," + 
                    xmltvFileSpec.StoreImagesLocally + "," +
                    xmltvFileSpec.ProcessNewTag + "," +
                    xmltvFileSpec.SetPreviouslyShownDefault + "," +
                    xmltvFileSpec.ProcessLiveTag);                
            }
            ...
            if (importChannelChanges != null)
            {
                ...
                {
                    if (!string.IsNullOrWhiteSpace(channelChange.NewName) || !string.IsNullOrWhiteSpace(channelChange.CallSign))
                    {
                        streamWriter.WriteLine("XmltvChannelChange=" + channelChange.DisplayName + "," +
                            ...
                            (string.IsNullOrWhiteSpace(channelChange.NewName) ? "" : channelChange.NewName) + "," +
                            (string.IsNullOrWhiteSpace(channelChange.CallSign) ? "" : channelChange.CallSign)
                            );
                    }
                    else
                    {
        ...
        private void outputTranslateParameters(StreamWriter streamWriter)
        {
            if (string.IsNullOrWhiteSpace(translationApiKey))
                return;

            streamWriter.WriteLine();
            streamWriter.WriteLine("[TRANSLATIONS]");

            streamWriter.WriteLine("TranslationApiKey=" + translationApiKey);
            streamWriter.WriteLine("TranslationLanguage=" + translationLanguage);

            foreach (TextTranslationSpec translationSpec in translationSpecs)
                streamWriter.WriteLine("TranslationSpec=" + translationSpec.OriginalNetworkID + "," +
                    translationSpec.TransportStreamID + "," +
                    translationSpec.ServiceID);
        }

        private void outputScheduleDirectParameters(StreamWriter streamWriter)
        {
            if (sdChannels == null)
                return;

            streamWriter.WriteLine();
            streamWriter.WriteLine("[SCHEDULESDIRECT]");

            streamWriter.WriteLine("SDStoreImagesLocally=" + sdStoreImagesLocally);
            streamWriter.WriteLine("SDUseLongDescriptions=" + (sdUseLongDescriptions ? "yes" : "no"));

            foreach (SchedulesDirectChannel channel in sdChannels)
            {
                streamWriter.WriteLine("SDChannel=" + channel.Identity + "," +
                channel.Name + "," +
                channel.CallSign + "," +
                channel.Affiliate + "," +
                channel.LineupIdentity + "," +
                channel.UserName + "," +
                channel.UserCallSign + "," +
                channel.MajorChannelNumber + "," +
                channel.MinorChannelNumber + "," +
                ...
                if (channel.Logos != null)
                {
                    foreach (string channelLogo in channel.Logos)
                        streamWriter.WriteLine("SDChannelLogo=" + channelLogo);
                }
            }
        }
        ...
        public RunParameters Clone()
        {
            ...
            newParameters.XmltvIconTagPathPrefix = xmltvIconTagPathPrefix;
            ...
            newParameters.LookupImageNameTitle = lookupImageNameTitle;
            newParameters.LookupImagesInBase = lookupImagesInBase;
            newParameters.LookupOverwrite = lookupOverwrite;
            newParameters.LookupEpisodeSearchPriority = lookupEpisodeSearchPriority;
            newParameters.LookupTVDBPin = lookupTVDBPin;
            ...
            if (importFiles != null)
            {
                ...
                foreach (ImportFileSpec oldSpec in importFiles)
                {
                    ...
                    newSpec.TimeZone = oldSpec.TimeZone;
                    newSpec.NoLookup = oldSpec.NoLookup;
                    newSpec.AppendOnly = oldSpec.AppendOnly;                    
                    newSpec.IgnoreEpisodeTags = oldSpec.IgnoreEpisodeTags;
                    newSpec.StoreImagesLocally = oldSpec.StoreImagesLocally;
                    newSpec.ProcessNewTag = oldSpec.ProcessNewTag;
                    newSpec.SetPreviouslyShownDefault = oldSpec.SetPreviouslyShownDefault;
                    newSpec.ProcessLiveTag = oldSpec.ProcessLiveTag;
            ...
            if (importChannelChanges != null)
            {
                ...
                foreach (ImportChannelChange oldChange in importChannelChanges)
                {
                    ...
                    newChange.CallSign = oldChange.CallSign;
            ...
            newParameters.TranslationApiKey = TranslationApiKey;
            newParameters.TranslationLanguage = TranslationLanguage;

            if (TranslationSpecs != null)
            {
                newParameters.TranslationSpecs = new Collection<TextTranslationSpec>();

                foreach (TextTranslationSpec translationSpec in TranslationSpecs)
                    newParameters.TranslationSpecs.Add(translationSpec.Clone());
            }            

            if (sdChannels != null)
            {
                newParameters.SdStoreImagesLocally = sdStoreImagesLocally;
                newParameters.SdUseLongDescriptions = sdUseLongDescriptions;

                newParameters.SdChannels = new Collection<SchedulesDirectChannel>();

                foreach (SchedulesDirectChannel channel in SdChannels)
                    newParameters.SdChannels.Add(channel.Clone());
            }
        ...
        public DataState HasDataChanged(RunParameters oldParameters)
        {
            ...
            if (xmltvIconTagPathPrefix == null)
            {
                if (oldParameters.XmltvIconTagPathPrefix != null)
                    return (DataState.Changed);
            }
            else
            {
                ...
                {
                    if (xmltvIconTagPathPrefix != oldParameters.XmltvIconTagPathPrefix)
                        return (DataState.Changed);
                }
            }
            ...
            if (lookupErrorLimit != oldParameters.LookupErrorLimit ||
                ...
                lookupMatchThreshold != oldParameters.LookupMatchThreshold ||
            ...
            if (lookupImageNameTitle != oldParameters.LookupImageNameTitle)
                return (DataState.Changed);
            if (lookupImagesInBase != oldParameters.LookupImagesInBase)
                return (DataState.Changed);
            if (lookupOverwrite != oldParameters.LookupOverwrite)
                return (DataState.Changed);
            if (lookupEpisodeSearchPriority != oldParameters.LookupEpisodeSearchPriority)
                return (DataState.Changed);
            if (lookupTVDBPin != oldParameters.LookupTVDBPin)
                return (DataState.Changed);
            ...
            if (oldParameters.ImportFiles != null)
            {
                ...
                for (int index = 0; index < oldParameters.ImportFiles.Count; index++)
                {
                    ...
                    if (oldSpec.TimeZone != newSpec.TimeZone)
                        return (DataState.Changed);
                    ...
                    if (oldSpec.IgnoreEpisodeTags != newSpec.IgnoreEpisodeTags)
                        return (DataState.Changed);

                    if (oldSpec.StoreImagesLocally != newSpec.StoreImagesLocally)
                        return (DataState.Changed);

                    if (oldSpec.ProcessNewTag != newSpec.ProcessNewTag)
                        return (DataState.Changed);

                    if (oldSpec.SetPreviouslyShownDefault != newSpec.SetPreviouslyShownDefault)
                        return (DataState.Changed);

                    if (oldSpec.ProcessLiveTag != newSpec.ProcessLiveTag)
                        return (DataState.Changed);
                }
            }
            ...
            if (oldParameters.ImportChannelChanges != null)
            {
                ...
                for (int index = 0; index < oldParameters.ImportChannelChanges.Count; index++)
                {
                    ...
                    if (oldChange.CallSign == null && newChange.CallSign != null)
                        return (DataState.Changed);
                    if (oldChange.CallSign != null && newChange.CallSign == null)
                        return (DataState.Changed);
                    if (oldChange.CallSign != null && oldChange.CallSign != newChange.CallSign)
                        return (DataState.Changed);
            ...
            if (oldParameters.TranslationApiKey != translationApiKey)
                return DataState.Changed;
            if (oldParameters.TranslationLanguage != translationLanguage)
                return DataState.Changed;

            if ((oldParameters.TranslationSpecs != null && translationSpecs == null) || (oldParameters.TranslationSpecs == null && translationSpecs != null))
                return DataState.Changed;
            
            if (oldParameters.TranslationSpecs != null)
            {
                if (oldParameters.TranslationSpecs.Count != translationSpecs.Count)
                    return DataState.Changed;

                Collection<TextTranslationSpec> oldSpecs = new Collection<TextTranslationSpec>();
                foreach (TextTranslationSpec oldSpec in oldParameters.TranslationSpecs)
                    oldSpecs.Add(oldSpec);

                foreach (TextTranslationSpec newSpec in TranslationSpecs)
                    removeTranslationSpec(oldSpecs, newSpec);

                if (oldSpecs.Count != 0)
                    return DataState.Changed;
            }

            if (oldParameters.SdStoreImagesLocally != sdStoreImagesLocally)
                return DataState.Changed;
            if (oldParameters.SdUseLongDescriptions != sdUseLongDescriptions)
                return DataState.Changed;

            if ((oldParameters.SdChannels != null && sdChannels == null) || (oldParameters.SdChannels == null && sdChannels != null))
                return DataState.Changed;

            if (oldParameters.SdChannels != null)
            {
                if (oldParameters.SdChannels.Count != sdChannels.Count)
                    return DataState.Changed;

                Collection<SchedulesDirectChannel> oldChannels = new Collection<SchedulesDirectChannel>();
                foreach (SchedulesDirectChannel oldChannel in oldParameters.SdChannels)
                    oldChannels.Add(oldChannel);

                foreach (SchedulesDirectChannel newChannel in SdChannels)
                    removeSdChannel(oldChannels, newChannel);
        ...
        private void removeTranslationSpec(Collection<TextTranslationSpec> oldSpecs, TextTranslationSpec newSpec)
        {
            foreach (TextTranslationSpec oldSpec in oldSpecs)
            {
                if (oldSpec.OriginalNetworkID == newSpec.OriginalNetworkID && oldSpec.TransportStreamID == newSpec.TransportStreamID && oldSpec.ServiceID == newSpec.ServiceID)
                {
                    oldSpecs.Remove(oldSpec);
                    return;
                }
            }
        }

        private void removeSdLineup(Collection<SchedulesDirectLineup> oldLineups, SchedulesDirectLineup newLineup)
        {
            foreach (SchedulesDirectLineup oldLineup in oldLineups)
            {
                if (!oldLineup.CompareTo(newLineup))
                {
                    oldLineups.Remove(oldLineup);
                    return;
                }
            }
        }

        private void removeSdChannel(Collection<SchedulesDirectChannel> oldChannels, SchedulesDirectChannel newChannel)
        {
            foreach (SchedulesDirectChannel oldChannel in oldChannels)
            {
                if (!oldChannel.CompareTo(newChannel))
                {
                    oldChannels.Remove(oldChannel);
                    return;
                }
            }
        }
