    ...
    public sealed class OutputFilePlugin
    {
        ...
        private static void processEPGEntry(XmlWriter xmlWriter, EPGEntry epgEntry)
        {
            ...
            if (epgEntry.EventCategory != null)
            {
                ...
                string description = epgEntry.EventCategory.GetDescription(EventCategoryMode.DvbLogic);
                if (!string.IsNullOrWhiteSpace(description))
                {
                    string[] categoryParts = description.Split(new char[] { ',' });
        ...
        private static void writeCredit(XmlWriter xmlWriter, Collection<Person> credits, string name)
        {
            ...
            foreach (Person credit in credits)
            {
                ...
                creditString.Append(credit.Name);
            }
