...
namespace DomainObjects
{
    ...
    public class LanguageCode
    {
        ...
        /// Lookup code 2.
        /// </summary>
        public string LookupCode2
        {
            get { return (lookupCode2); }
            set { lookupCode2 = value; }
        }
                    ...
                    if (reader.IsStartElement())
                    {
                        switch (reader.Name)
                        {
                            case "LanguageCode":
                                ...
                                string lookupCode2 = reader.GetAttribute("lookupCode2");
                                if (lookupCode2 != null)
                                    languageCode.LookupCode2 = lookupCode2.Trim().ToLowerInvariant();
