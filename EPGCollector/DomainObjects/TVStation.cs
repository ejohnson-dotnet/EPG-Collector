...
namespace DomainObjects
{
    ...
    public class TVStation : INotifyPropertyChanged
    {
        ...
        /// </summary>
        public string WMCCallSign
        {
            get { return (wmcCallSign); }
            set { wmcCallSign = value; }
        }

        /// <summary>
        /// Get or set the Import call sign. 
        /// </summary>
        public string ImportCallSign
        {
            get { return (importCallSign); }
            set { importCallSign = value; }
        }
            ...
            get 
            {
                ...
                else
                {
                    if (transportStreamID > 0)
                        return transportStreamID + "," + serviceID;
                    else
        ...
        /// </summary>
        public bool IgnoreFrequencyForMerge
        {
            get { return (ignoreFrequencyForMerge); }
            set { ignoreFrequencyForMerge = value; }
        }
        ...
        /// </summary>
        public int AtscProgramNumber
        {
            get { return (atscProgramNumber); }
            set { atscProgramNumber = value; }
        }

        /// <summary>
        /// Get or set the ATSC hidden flag.
        /// </summary>
        public bool AtscHidden
        {
            get { return (atscHidden); }
            set { atscHidden = value; }
        }

        /// <summary>
        /// Get or set the ATSC access controlled flag.
        /// </summary>
        public bool AtscAccessControlled
        {
            get { return (atscAccessControlled); }
            set { atscAccessControlled = value; }
        }

        /// <summary>
        /// Get or set the ATSC out of band flag.
        /// </summary>
        public bool AtscOutOfBand
        {
            get { return (atscOutOfBand); }
            set { atscOutOfBand = value; }
        }

        /// <summary>
        /// Get or set the ATSC guide hidden flag.
        /// </summary>
        public bool AtscGuideHidden
        {
            get { return (atscGuideHidden); }
            set { atscGuideHidden = value; }
        }

        /// <summary>
        /// Get or set the ATSC service type.
        /// </summary>
        public int AtscServiceType
        {
            get { return (atscServiceType); }
            set { atscServiceType = value; }
        }
        ...
        /// <summary>
        /// True if the channel has benn included in the Channel Definitions file; false otherwise.
        /// </summary>
        public bool InChannelDefinitions
        {
            get { return (inChannelDefinitions); }
            set { inChannelDefinitions = value; }
        }
        ...
        private bool ignoreFrequencyForMerge;
        private bool inChannelDefinitions;
                
        private string newName;        
        private int logicalChannelNumber = -1;
        private int minorChannelNumber = -1;
        private TunerType tunerType = TunerType.Other;
        private Satellite satellite;
        private int originalChannelNumber = -1;
        private string channelID;
        private TVStationType stationType = TVStationType.Undefined;
        private string wmcMatchName;
        private string wmcUniqueID;
        private string wmcCallSign;
        private string importCallSign;
        private string affiliate;
        private Collection<ConditionalAccessEntry> conditionalAccessEntries;
        
        private int atscTSID;
        private int atscProgramNumber;
        private bool atscHidden;
        private bool atscAccessControlled;
        private bool atscOutOfBand;
        private bool atscGuideHidden;
        private int atscServiceType;
        ...
        /// </summary>
        /// <param name="stations">The list of stations to process.</param>
        /// <param name="originalNetworkID">The original network ID of the station (0=no check).</param>
        ...
        public static TVStation FindStation(Collection<TVStation> stations, int originalNetworkID, int transportStreamID, int serviceID)
        {
            foreach (TVStation tvStation in stations)
            {
                ...
                {
                    if (tvStation.TransportStreamID == transportStreamID && tvStation.ServiceID == serviceID)
                        return (tvStation);
                }
            }
        ...
        public TVStation Clone()
        {
            ...
            newStation.Affiliate = affiliate;            
