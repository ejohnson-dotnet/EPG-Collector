...
namespace EPGCentre
{
    internal partial class ChangeCustomCategoriesControl : BaseChangeCategoryControl, IUpdateControl
    {
        /// <summary>
        ...
        internal ChangeCustomCategoriesControl()
        {
            InitializeComponent();
        }
        ...
        {
            if (!CustomProgramCategory.Load(fileName))
                return (false);
            ...
            foreach (ProgramCategory category in CustomProgramCategory.Categories)
        ...
        protected override DataState HasDataChanged()
        {
            ...
            {
                ProgramCategory existingCategory = CustomProgramCategory.FindCategory(category.CategoryTag);
        ...
        public bool PrepareToSave()
        {
            ...
            {
                if (!category.IsEmpty)
                    CustomProgramCategory.Categories.Add(category);
            }
