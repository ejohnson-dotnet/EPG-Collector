...
namespace EPGCentre
{
    internal partial class ViewLogControl : UserControl, IView
    {
        ...
        internal ViewLogControl()
        {
            InitializeComponent();
        }

        internal void Process(string logFileName, Logger logger, bool useInformation)
        {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    if ((string)e.Value == warningText)
                                    {
                                        dgViewLog.Rows[e.RowIndex].DefaultCellStyle.BackColor = Color.LightSalmon;
                                        dgViewLog.Rows[e.RowIndex].DefaultCellStyle.ForeColor = Color.White;
                                    }
                                }
                            }
