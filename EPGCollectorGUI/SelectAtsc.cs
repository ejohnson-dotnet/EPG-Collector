...
namespace EPGCentre
{
    internal partial class SelectAtsc : Form
    {
        /// <summary>
        ...
        /// </summary>
        public AtscFrequency Frequency { get { return (lbFrequency.SelectedItem as AtscFrequency); } }
        ...
        private void cboProvider_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            foreach (AtscFrequency frequency in ((AtscProvider)cboProvider.SelectedItem).Frequencies)
