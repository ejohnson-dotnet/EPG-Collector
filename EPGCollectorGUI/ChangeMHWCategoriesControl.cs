...
namespace EPGCentre
{
    internal partial class ChangeMHWCategoriesControl : BaseChangeCategoryControl , IUpdateControl
    {
        /// <summary>
        ...
        internal ChangeMHWCategoriesControl()
        {
            InitializeComponent();
        }
        ...
        {
            if (!MediaHighwayProgramCategory.Load(fileName))
                return (false);
            ...
            foreach (ProgramCategory category in MediaHighwayProgramCategory.Categories)
        ...
        protected override DataState HasDataChanged()
        {
            ...
            {
                ProgramCategory existingCategory = MediaHighwayProgramCategory.FindCategory(category.CategoryTag);
        ...
        public bool PrepareToSave()
        {
            ...
            {
                if (!category.IsEmpty)
                    MediaHighwayProgramCategory.Categories.Add(category);
            }
