...
namespace EPGCentre
{
    internal partial class ChangeDishNetworkCategoriesControl : BaseChangeCategoryControl, IUpdateControl
    {
        /// <summary>
        ...
        internal ChangeDishNetworkCategoriesControl()
        {
            InitializeComponent();
        }
        ...
        {
            if (!DishNetworkProgramCategory.Load(fileName))
                return (false);
            ...
            foreach (ProgramCategory category in DishNetworkProgramCategory.Categories)
        ...
        protected override DataState HasDataChanged()
        {
            ...
            {
                ProgramCategory existingCategory = DishNetworkProgramCategory.FindCategory(category.CategoryTag);
        ...
        public bool PrepareToSave()
        {
            ...
            {
                if (!category.IsEmpty)
                    DishNetworkProgramCategory.Categories.Add(category);
            }
