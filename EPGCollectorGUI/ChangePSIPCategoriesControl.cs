...
namespace EPGCentre
{
    internal partial class ChangePSIPCategoriesControl : BaseChangeCategoryControl, IUpdateControl
    {
        /// <summary>
        ...
        internal ChangePSIPCategoriesControl()
        {
            InitializeComponent();
        }
        ...
        {
            if (!AtscPsipProgramCategory.Load(fileName))
                return (false);
            ...
            foreach (ProgramCategory category in AtscPsipProgramCategory.Categories)
        ...
        protected override DataState HasDataChanged()
        {
            ...
            {
                ProgramCategory existingCategory = AtscPsipProgramCategory.FindCategory(category.CategoryTag);
        ...
        public bool PrepareToSave()
        {
            ...
            {
                if (!category.IsEmpty)
                    AtscPsipProgramCategory.Categories.Add(category);
            }
