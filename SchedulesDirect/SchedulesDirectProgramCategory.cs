...
{
    /// <summary>
    /// The class that describes a Schedules Direct program category.
    /// </summary>
    public class SchedulesDirectProgramCategory : ProgramCategory
    {
        /// <summary>
        /// Get the collection of Schedules Direct categories.
        /// </summary>
        ...
        /// <summary>
        /// Get the collection of undefined Schedules Direct categories.
        /// </summary>
        ...
        /// <summary>
        /// Get the XMLTV categories standard filename.
        /// </summary>
        public static string FileName { get { return ("Schedules Direct Categories"); } }

        private static Collection<ProgramCategory> categories;
        private static Collection<ProgramCategory> undefinedCategories;

        private SchedulesDirectProgramCategory() { }
        ...
        {
            foreach (ProgramCategory undefinedCategory in UndefinedCategories)
            {
                if (undefinedCategory.CategoryTag == category)
